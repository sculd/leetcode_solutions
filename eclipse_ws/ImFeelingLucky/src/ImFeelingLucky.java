...
class Solution	{
	...
	public int getNumberOfLuckyBusTickets()	{
		...
		for (int three_sum = 0; three_sum <= 27; three_sum++)	{
			int num_pos = num_possibilities.get(three_sum);
			System.out.println("three_sum: " + three_sum + ", pos: " + num_pos);
			num_lucky += num_pos * num_pos; 
		}
...
public class ImFeelingLucky {
	...
	public static void main(String[] args) {
		...
		System.out.println(sol.getNumberOfLuckyBusTickets());
	}
